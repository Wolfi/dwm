...
#include "colors/mellifluous.h"
static char *colors[][3]  = {
  /*                     fg   bg   border */
  [SchemeNorm]       = { fg2, bg0, bg0 },
  [SchemeSel]        = { bg1, fg2, bluu },
  [SchemeTag]        = { fg2, bg0, bg1 },
  [SchemeTag1]       = { orange, bg1,  bg1 },
  [SchemeTag2]       = { yellow, bg1, bg1 },
  [SchemeTag3]       = { green, bg1, bg1 },
  [SchemeTag4]       = { aqua, bg1, bg1 },
  [SchemeTag5]       = { bluu, bg1, bg1 },
  [SchemeTag6]       = { purple, bg1, bg1 },
  [SchemeLayout]     = { fg0, bg0, bg1 },
  [SchemeTitle]      = { fg0, bg0, bg1 },
  [SchemeTitle1]     = { orange, bg0,  bg1 },
  [SchemeTitle2]     = { yellow, bg0, bg1 },
...
/* tagging */
static const char *tags[] = { "", "", "", "", "󱞁", "󰲫", "󰲭", "󰲯", "󰲱" };
